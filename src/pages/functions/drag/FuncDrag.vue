<template>
  <div>
    <el-card>
      ...
      {{$t('else.example')}}
      <a href="https://github.com/linjinze999/vue-llplatform/blob/master/src/s/functions/drag/FuncDrag.vue"
         style="color: #409eff" target="_blank">
        https://github.com/linjinze999/vue-llplatform/blob/master/src/s/functions/drag/FuncDrag.vue
      </a>
    </el-card>
    <br/>
    <el-card>
